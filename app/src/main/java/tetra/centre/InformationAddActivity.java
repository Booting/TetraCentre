...
public class InformationAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_information_add);

        initToolbar();

        appsPref 	     = getSharedPreferences(Config.PREF_NAME, Activity.MODE_PRIVATE);
        queue    	     = Volley.newRequestQueue(this);
        fontLatoBold     = FontCache.get(InformationAddActivity.this, "Lato-Bold");
        fontLatoRegular  = FontCache.get(InformationAddActivity.this, "Lato-Regular");
        fontLatoHeavy    = FontCache.get(InformationAddActivity.this, "Lato-Heavy");
        fontLatoBlack    = FontCache.get(InformationAddActivity.this, "Lato-Black");
        fontLatoItalic   = FontCache.get(InformationAddActivity.this, "Lato-Italic");
        ...
        lblUploadFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /////////////////////////////////////////////////////////////////////////////////////////////////
                SimpleFileDialog FileOpenDialog =  new SimpleFileDialog(InformationAddActivity.this, "FileOpen",
                        new SimpleFileDialog.SimpleFileDialogListener() {
                            @Override
                            public void onChosenDir(String chosenDir) {
                                File file = new File(chosenDir);
                                if (file.getName().toLowerCase().endsWith("jpeg") || file.getName().toLowerCase().endsWith("pdf") ||
        ...
        pDialog = new ProgressDialog(InformationAddActivity.this);
        pDialog.setMessage("Working...");
        pDialog.setCancelable(false);
    }

    private void initToolbar() {
        SpannableString spanToolbar = new SpannableString("Information - Add");
        spanToolbar.setSpan(new TypeFaceSpan(InformationAddActivity.this, "Lato-Bold"), 0, spanToolbar.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    private class addNewInformation extends AsyncTask<String, Void, String> {
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog.show();
        ...
        protected String doInBackground(String... params) {
            ...
            url = Config.URL + "/service.php?ct=ADDINFORMATION&UserId=" + appsPref.getString("UserId", "") +
                    "&Name=" + strName +
        ...
        protected void onPostExecute(String result) {
            super.onPostExecute(result);
            Toast.makeText(getApplicationContext(), "Add new information succesfully!", Toast.LENGTH_LONG).show();
            setResult(RESULT_OK);
            finish();
        }
    }
