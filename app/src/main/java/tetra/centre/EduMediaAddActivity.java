...
public class EduMediaAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edumedia_add);

        initToolbar();

        appsPref 	     = getSharedPreferences(Config.PREF_NAME, Activity.MODE_PRIVATE);
        queue    	     = Volley.newRequestQueue(this);
        fontLatoBold     = FontCache.get(EduMediaAddActivity.this, "Lato-Bold");
        fontLatoRegular  = FontCache.get(EduMediaAddActivity.this, "Lato-Regular");
        fontLatoHeavy    = FontCache.get(EduMediaAddActivity.this, "Lato-Heavy");
        fontLatoBlack    = FontCache.get(EduMediaAddActivity.this, "Lato-Black");
        fontLatoItalic   = FontCache.get(EduMediaAddActivity.this, "Lato-Italic");
        ...
        lblUploadFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /////////////////////////////////////////////////////////////////////////////////////////////////
                SimpleFileDialog FileOpenDialog =  new SimpleFileDialog(EduMediaAddActivity.this, "FileOpen",
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (pathOne==null) {
                    Toast.makeText(getApplicationContext(), "Media is required!", Toast.LENGTH_SHORT).show();
        ...
        pDialog = new ProgressDialog(EduMediaAddActivity.this);
        pDialog.setMessage("Working...");
        pDialog.setCancelable(false);
    }

    private void initToolbar() {
        SpannableString spanToolbar = new SpannableString("EduMedia - Add");
        spanToolbar.setSpan(new TypeFaceSpan(EduMediaAddActivity.this, "Lato-Bold"), 0, spanToolbar.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    private class addNewMedia extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            url = Config.URL + "/service.php?ct=ADDEDUMEDIA&UserId=" + appsPref.getString("UserId", "") +
                    "&Title=" + strName +
        ...
        protected void onPostExecute(String result) {
            super.onPostExecute(result);
            Toast.makeText(getApplicationContext(), "Add new EduMedia succesfully!", Toast.LENGTH_LONG).show();
            setResult(RESULT_OK);
            finish();
        }
    }
